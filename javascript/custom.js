// Sidebar navigation and setup, only show navigation when the width is greather than or equal to 991px
...
$(document).ready(function() {
	$.simpleWeather({
		...
		success: function(weather) {
			html = '<div class="sidebar-weather">';
			html += '<div class="sidebar-weather-header">';
			html += '<h6>' + weather.city + ', ' + weather.region + ' Weather</h6></div>';
			html += '<div class="sweather-left">';
			html += '<img src="' + weather.image + '"></div>';
			html += '<div class="sweather-right">';
			html += '<span class="sweather-big">' + weather.temp + '&deg;' + weather.units.temp + '</span></div>';
			html += '<div class="clearfix"></div>'
			html += '<div class="sidebar-weather-footer">'
			html += '<p>' + weather.currently + ", ";
			html += '<a href="' + weather.link + '">View Forecast &raquo;</a></p></div></div>';
